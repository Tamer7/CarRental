    ...
    <div class="white-box">
        ...
        <form action="{{route('FrontendCheckoutCharge')}}" method="POST" class="table-responsive">
            ...
            <table class="table table-bordered shop_table shop_table_responsive cart">
                ...
                <tbody>
                    <tr>
                        <td class="col-md-1">
                            @if($product->img > 0)
                            <img class="" style="margin-right: 10px;" src="{{ the_image_url($product->img,'thumbnail-260x260') }}" alt="{{$product->title}}" width="80">
                            @endif
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <button style="height: 50px;" type="button" class="btn btn-theme pull-right btn-apply-coupon">
                        Apply Coupon
                    </button>
                </div>
            ...
            <tr>
                <td colspan="5" style="font-size: 120%;" class="font-500" align="right"><b>{{__('Total')}}: {{ formatted_price($ecommerce_cart['total_price'])}}</b>
                </td>
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-theme pull-right btn-reservation-now" href="#">{{__('Place order')}}
                </button>
            </div>
            @else
